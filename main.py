...
# Efek Suara (aman: jika gagal dimuat, game tetap berjalan tanpa suara)
class _DummySound:
    def play(self, *args, **kwargs):
        pass

sfx_food = _DummySound()
sfx_trap = _DummySound()
sfx_over = _DummySound()
try:
    pygame.mixer.init()
...
# Mendefinisikan font untuk teks dalam permainan (fallback jika font tidak tersedia)
try:
...
def button(msg, x, y, w, h, inactive_color, active_color, action=None):
    ...
    text_surf = button_font.render(msg, True, black)
